...
public class JdbcTimesheetDao implements TimesheetDao {
    ...
    public List<Timesheet> getAllTimesheets() {
        ...
        while(results.next()) {
            ...
            long id = results.getLong("timesheet_id");
            long empId = results.getLong("employee_id");
            long projId = results.getLong("project_id");
            LocalDate dateWorked = results.getDate("date_worked").toLocalDate();
            double hours = results.getDouble("hours_worked");
            boolean isBillable = results.getBoolean("billable");
            String desc = results.getString("description");



            Timesheet timeS = new Timesheet(id, empId, projId, dateWorked, hours, isBillable, desc);
