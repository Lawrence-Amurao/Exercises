...
// 1. Add default rule that states that all endpoints should be secured.
...
public class HotelController {
    ...
    // 3. Add a rule saying only admins are allowed to visit this endpoint.
