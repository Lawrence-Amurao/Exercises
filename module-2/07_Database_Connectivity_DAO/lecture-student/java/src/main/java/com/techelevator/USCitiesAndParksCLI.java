...
public class USCitiesAndParksCLI {
    ...
    // Setup: declare an instance variable for CityDao.
    ...
    public USCitiesAndParksCLI(DataSource dataSource) {
        ...
        // Setup: instantiate the cityDAO instance variable with an object
        // of JdbcCityDao.
        ...
        City testCity = cityDao.getCity(74);
    ...
    private void updateCity(City cityToUpdate) {
        ...
        // 2. Invoke the correct DAO method to update city data.
    ...
    private void deleteCity(City cityToDelete) {
        ...
        if (state != null) {
            ...
            // 3. Invoke the correct DAO method to delete a city.
    ...
    private void addNewCity() {
        ...
        // 4. Invoke the correct DAO method to add a new city.
    ...
    private City promptForCity() {
        ...
        while (cities.size() == 0) {
            ...
            // 1. Invoke the correct DAO method to obtain a list of city objects.
