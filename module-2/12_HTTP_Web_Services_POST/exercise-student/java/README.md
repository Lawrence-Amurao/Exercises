...
* There are two helper methods you need to write. 
        One makes an `Auction` object given a CSV string containing either four or five elements. 
...
The makeAuction method must create a new auction from a CSV string. The CSV string may contain either four or five elements.
