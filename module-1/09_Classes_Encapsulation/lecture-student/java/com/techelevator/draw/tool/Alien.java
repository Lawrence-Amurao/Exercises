...
public class Alien {
    //define data members, data variable, fields, instance variables, class variables
    //always private access
    //these variables hold the stat of an object
    ...
    //create methods that define rhe behaviors -- getters and setters
    //methods we cn call outside of this class so access is public
    ...
    //getters 'get' the value of the field for us
