...
public class Exercises {
	...
	public String makeOutWord(String out, String word) {
		...
		String newString1 = out.substring(0, 2);
		String newString2 = out.substring(2, 4);
	...
	public String nonStart(String a, String b) {
		String con1 = a.substring(1);
		String con2 = b.substring(1);
		return con1 + con2;
	}
	...
	public String right2(String str) {
		...
		String len = str.substring(str.length() -2);
		return len + start;
	}
	...
	public String withoutEnd2(String str) {
		...
		int len2 = len - 1;
		if (len > 2) {
			String noBE = str.substring(1, len2);
			return noBE;
		}
		return "";
	}
	...
	public boolean hasBad(String str) {
		...
		String strB0 = str.substring(0, 3);
		String strB1 = str.substring(1, 4);
		if (hasB.equals(strB0) || strB1.equals(hasB)) {
			return true;
		}
		return false;
	}
	...
	public int countXX(String str) {
		...
		for (int i = 0; i < str.length() - 1; i++) {
			if(ex.equals(str.substring(i, (i + 2)))) {
				count += 1;
			}
		}
			return count;
	...
	public String stringX(String str) {
		String noX = "";
		String[] noxArray = str.split("");
		for (int i = 0; i < noxArray.length; i++) {
			if ((i == 0 && noxArray[0].equals("x")) || (i == noxArray.length -1 && noxArray[noxArray.length - 1].equals("x")) || (!noxArray[i].equals("x"))) {
				noX = noX + noxArray[i];
			}
		}
