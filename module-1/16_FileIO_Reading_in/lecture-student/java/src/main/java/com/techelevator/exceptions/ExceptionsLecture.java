...
public class ExceptionsLecture {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// If an ArrayIndexOutOfBounds is thrown, flow of control will be here
		...
		} catch (Exception e) { //Exception is a parent of NumberFormatException, this will catch error
